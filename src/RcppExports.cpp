...
RcppExport SEXP _GroupBoosting_compute_hat_mat_list(SEXP XSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _GroupBoosting_model_fitting(SEXP XSEXP, SEXP ySEXP, SEXP x_sizeSEXP, SEXP total_stepsSEXP, SEXP step_sizeSEXP, SEXP adj_varSEXP, SEXP stop_tolSEXP, SEXP gammaSEXP, SEXP stop_methodSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat& >::type X(XSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_GroupBoosting_compute_hat_mat_list", (DL_FUNC) &_GroupBoosting_compute_hat_mat_list, 1},
    {"_GroupBoosting_model_fitting", (DL_FUNC) &_GroupBoosting_model_fitting, 9},
    {NULL, NULL, 0}
};

RcppExport void R_init_GroupBoosting(DllInfo *dll) {
